...
## GLSLレイマーチング
GLSLレイマーチングで、3D表現を作ることが最近の趣味です。<br>
https://neort.io/Y2hWnzYpeUhPFLWEAZImqMboQI53<br>
<iframe height="315" style="width: 50%; height: 50%; overflow:hidden; display:block;" src="https://neort.io/embed/butoc6k3p9f7gigec0qg?autoStart=true&quality=1&info=true" frameborder="0" sandbox="allow-forms allow-modals allow-pointer-lock allow-popups allow-same-origin allow-scripts" allow="geolocation; microphone; camera; midi; vr" allowfullscreen="true" allowtransparency="true"></iframe>
<iframe height="315" style="width: 50%; height: 50%; overflow:hidden; display:block;" src="https://neort.io/embed/buo8u4s3p9f7gigeamng?autoStart=true&quality=1&info=false" frameborder="0"sandbox="allow-forms 
allow-modals allow-pointer-lock allow-popups allow-same-origin allow-scripts" allow="geolocation; microphone; camera; midi; vr" allowfullscreen="true" allowtransparency="true"></iframe>

<br>

#### GLSLレイマーチングの魅力

物理学・数学・レンダリングといった技術を組み合わせて表現を生み出せるところに魅力を感じています。<br>
...
## その他の趣味 : 手描きエフェクト
アニメの手描き調エフェクトを作ることに興味があって、絵を描く練習していたことがあります。(2019/6 ~ 2020/8)<br>
